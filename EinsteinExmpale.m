N = 80*80;  %number of neurons
num_of_iterations = 20000;
threshold = 1000;

%creating a vector from image
Img1 = imread("C:\Users\or\Documents\0.png");
newImg1 = imresize(Img1,[80,80]);
Img2 = imread("C:\Users\or\Documents\albert.png");
newImg2 = imresize(Img2,[80,80]);
Img3 = imread("C:\Users\or\Documents\5.png");
newImg3 = imresize(Img2,[80,80]);
...
thresholds = [1000 100 200 300 400];
...
%noise = 0.01;  %noise of 10 percent
 ...
 %   for r = 1:180
  %      if mat(c,r)>0
   %         mat(c,r) = 1000;
    ...
    %end
%end
Img4 = imread("C:\Users\or\Documents\albertGlasses.png");
newImg4 = imresize(Img4,[80,80]);
mem_4 = randi([0,1],80);
for c = 1:80
    for r = 1:80
        if newImg4(c,r)>100
...
mem4_vec = reshape(mem_4,[],1);
s_0 = mem4_vec;  %defining the maximum bumber of iterations for the system
...
for i=1:number_of_iter 
    rand_neuron = randi([500,6000],1);  %in order to work asynchronous we choose one neuron randomly 
    h_i = 0;
